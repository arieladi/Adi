...
|---|---|---|---|
| `src/adi/engine/param_edits.hpp`, `src/adi/engine/param_edits.cpp`, `tests/test_param_edits.cpp`; `CMakeLists.txt` source and test-target integration only; `README.md` headline line 9 (win grant, ADR-0122 d11 and 2026-09-23 ruling) | linux | `linux/param-edits` | 2026-09-23 |
