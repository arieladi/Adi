...
| `2026-09-27a-mac-device-automation.md` | (mac) | the device-host half of plug-in automation | for mac's return |
| `2026-09-27b-mac-scope-summing-suites.md` | (mac) | the UI for the scope, group summing, the Airwindows suites, track delay; the OScope/PsyScope research | for mac's return |
