...
**2273 checks across 24 suites**, green on 7 ABIs. Nothing is frozen.
...
| [`docs/DECISIONS.md`](docs/DECISIONS.md) | Decision log. Append-only. 120 entries. |
| [`drivers/`](drivers/) | OS-level pieces that are their own programs, MIT: the ADI virtual audio device (planned; ADR-0106, 0117 to 0119). Nothing in `src/` includes it. |
