...
**4705 checks across 48 suites**, green on 7 ABIs. Nothing is frozen.
...
| [`docs/format/schema.sql`](docs/format/schema.sql) | Normative DDL. Executable, and verified on every change. 46 tables. |
...
| [`docs/DECISIONS.md`](docs/DECISIONS.md) | Decision log. Append-only. 171 entries. |
