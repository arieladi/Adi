...
| **ADI Airwindows**: 160 algorithms in eleven suite plug-ins, auto gain | [`airwindows/`](airwindows) | [airwin2rack](https://github.com/baconpaul/airwin2rack) `b6eef0a`, MIT | `com.adi.airwindows.<suite>` | GPLv3 |
...
**Eleven suites** (ADR-0171), one CLAP plug-in each, named
"ADI Airwindows - <group>": Distortion, Consoles, Tape, Amp Sims, Reverb,
Lo-Fi & Mod, Noise & Dynamics, Secret Weapons, Delay, Stereo and Sub. Inside a
suite, the Algorithm parameter chooses what plays.
