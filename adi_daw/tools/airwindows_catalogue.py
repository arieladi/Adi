...
# The suites (ADR-0171): the kept algorithms ship as eleven CLAP plug-ins, one
...
SUITES = [
    ...
    ("consoles", "ADI Airwindows - Consoles", {"Consoles", "Tone Color"}),
...
def write_catalogue(effects, out, pin):
    ...
    lines = [
        ...
        "suite CLAP plug-ins, \"ADI Airwindows - <group>\" (ADR-0171); the rest are listed "
...
def main():
    ...
    orphans = [e["name"] for e in effects if e["keep"]
