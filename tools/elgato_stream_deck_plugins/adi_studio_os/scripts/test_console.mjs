...
// Settled on hardware: Clear left, 0 centred under the 2/5/8 column like a real
// numpad, decimal out on the right next to Enter (Button 35).
ok("(5,3)=clear  (6,3)=0  (7,3)=decimal on Button 35",
   at(5, 3) === "clear" && at(6, 3) === "0" && at(7, 3) === "decimal" && S.btn(7, 3) === 35);
ok("0 is centred under 2/5/8", at(6, 0) === "8" && at(6, 1) === "5" && at(6, 2) === "2" && at(6, 3) === "0");
